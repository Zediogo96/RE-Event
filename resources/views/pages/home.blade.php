    ...
    <div id="carouselSlider" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{$events[0]->photos[0]->path}}" class="w-100 h-200" alt="Event {{$events[0]->eventid}} photo">
            ...
            @for ($i = 1; $i <= 2; $i++) <div class="carousel-item">
                <img src="{{$events[$i]->photos[0]->path}}" class="w-100 h-200 " alt="Event {{$events[$i]->eventid}} photo">
                <div class="carousel-caption ">
...
<div class="container-other-events">
    ...
    <a href="{{route('event.show', $event->eventid)}}">
        <div class="event-card">
            <img loading="lazy" src="{{$event -> photos[0]->path}}" alt="" class="card-image" alt="Event {{$event->eventid}} photo">
