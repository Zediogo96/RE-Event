            ...
            <div class="modal-content" id="edit-modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="teste-form" method='post' action="{{ route('updateEvent', ['eventid' => $event->eventid])}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @csrf
                        <input type="hidden" id="hidden-event-id2" name="event_id2" value='{{$event->eventid}}'>
                    ...
                    <div id="preview-container" style="position:relative">
                        ...
                        <img id="preview-image" style="border-radius: 5%;">
                        ...
                        <nav>
                            <ul id="menu-info">
                                <li class="menu-info-item text-center" style="width: 11rem;">
                                    <div> Location </div>
                                    <p style="font-size: 15px" id="preview-location">  </p>
                                </li>
                                <li class="menu-info-item text-center" style="width: 11rem;">
                                    <div> Capacity </div>
                                    <p id="preview-capacity" style="font-size: 15px"> places </p>
                                </li>
                                <li class="menu-info-item text-center" style="width: 11rem;">
                                    <div> Address </div>
                                    <p id="preview-address" style="font-size: 15px">  </p>
                                </li>
                            </ul>
                        </nav>
